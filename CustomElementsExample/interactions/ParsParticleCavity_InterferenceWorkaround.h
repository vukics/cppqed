// -*- C++ -*-
#ifndef   INTERACTIONS_PARSPARTICLECAVITY_INTERFERENCEWORKAROUND_H_INCLUDED
#define   INTERACTIONS_PARSPARTICLECAVITY_INTERFERENCEWORKAROUND_H_INCLUDED
...
#endif // INTERACTIONS_PARSPARTICLECAVITY_INTERFERENCEWORKAROUND_H_INCLUDED
