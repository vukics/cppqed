...
#ifndef   UTILS_INCLUDE_DRIVENDAMPEDHARMONICOSCILLATOR_H_INCLUDED
#define   UTILS_INCLUDE_DRIVENDAMPEDHARMONICOSCILLATOR_H_INCLUDED
...
#endif // UTILS_INCLUDE_DRIVENDAMPEDHARMONICOSCILLATOR_H_INCLUDED
