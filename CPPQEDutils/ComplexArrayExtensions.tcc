...
#ifndef   CPPQEDCORE_UTILS_COMPLEXARRAYEXTENSIONS_TCC_INCLUDED
#define   CPPQEDCORE_UTILS_COMPLEXARRAYEXTENSIONS_TCC_INCLUDED
...
#define BOOST_PP_FILENAME_1 "ComplexArrayExtensions.tcc"
...
{
  static_assert( tmptools::AssertEvenAndDivideBy2_v<TWO_TIMES_RANK>, "Odd total RANK for hermitian conjugation." );
  array=conj(array); 
...
#endif // CPPQEDCORE_UTILS_COMPLEXARRAYEXTENSIONS_TCC_INCLUDED
