...
print compare(.25,2.*gamma,3, [5e-6, 1.4e-8, 3e-6] ) & compare(.346,gamma,4, [3e-5, 1.5e-7, 1.5e-5] ) & compare(.26,gamma,5, [1.5e-5, 1.5e-8, 1e-5] ) & comparev(1.25,2.*kappa, [ [0,6,eps0], [1,6,eps0], [0,7,eps0], [1,7,eps0] ] ) & comparev(1,kappa, [ [0,8,eps1], [1,8,eps1] ] ) & comparev(-.5,kappa, [ [0,9,eps2], [1,9,eps2] ] ) & comparev(8,2.*kappa, [ [2,6,0.0015], [3,6,3e-9], [2,7,0.005], [3,7,0.0015] ] , [.5,2] )
