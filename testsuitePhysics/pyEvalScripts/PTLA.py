...
print compare((1+trajectories[0][2])/2,2, [ 1.8e-7, .00065, .00035 ] ) & compare((1-trajectories[0][2])/2,3, [ 1.8e-7, .00065, .00035 ] ) & compare(trajectories[0][3]/2,4, [ 1.5e-8, .0002, 4e-5 ] ) & compare(trajectories[0][4]/2,5, [ 1.5e-7, .00065, .0002 ] )
