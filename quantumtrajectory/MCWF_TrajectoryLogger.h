// -*- C++ -*-
#ifndef QUANTUMTRAJECTORY_TRAJECTORYLOGGER_H_INCLUDED
#define QUANTUMTRAJECTORY_TRAJECTORYLOGGER_H_INCLUDED
...
#endif // QUANTUMTRAJECTORY_TRAJECTORYLOGGER_H_INCLUDED
