...
// -*- C++ -*-
/// \briefFileDefault
#ifndef CPPQEDCORE_QUANTUMDATA_NONORTHOGONALSTATEVECTOR_H_INCLUDED
#define CPPQEDCORE_QUANTUMDATA_NONORTHOGONALSTATEVECTOR_H_INCLUDED
...
#endif // CPPQEDCORE_QUANTUMDATA_NONORTHOGONALSTATEVECTOR_H_INCLUDED
