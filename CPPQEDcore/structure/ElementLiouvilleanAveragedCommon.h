...
private:
  virtual size_t nAvr_v() const final {return keyPrinter_.length();}

  virtual std::ostream& displayKey_v(std::ostream& os, size_t& i) const final {return keyPrinter_.displayKey(os,i);}
