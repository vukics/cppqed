...
#ifndef   UTILS_DRIVENDAMPEDHARMONICOSCILLATOR_H_INCLUDED
#define   UTILS_DRIVENDAMPEDHARMONICOSCILLATOR_H_INCLUDED
...
#endif // UTILS_DRIVENDAMPEDHARMONICOSCILLATOR_H_INCLUDED
