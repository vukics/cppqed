// -*- C++ -*-
#ifndef   FREES_TIMEINDEPENDENTMATRIXHAMILTONIAN_H_INCLUDED
#define   FREES_TIMEINDEPENDENTMATRIXHAMILTONIAN_H_INCLUDED
...
#endif // FREES_TIMEINDEPENDENTMATRIXHAMILTONIAN_H_INCLUDED
