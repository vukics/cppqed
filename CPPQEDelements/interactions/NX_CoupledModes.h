...
// -*- C++ -*-
#ifndef   CPPQEDELEMENTS_INTERACTIONS_NX_COUPLEDMODES_H_INCLUDED
#define   CPPQEDELEMENTS_INTERACTIONS_NX_COUPLEDMODES_H_INCLUDED
...
#endif // CPPQEDELEMENTS_INTERACTIONS_NX_COUPLEDMODES_H_INCLUDED
