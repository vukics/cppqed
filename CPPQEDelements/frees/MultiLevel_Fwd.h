...
template<int NL, typename VP, bool IS_DIFFUSIVE, typename Averaged=ReducedDensityOperator<1> > 
...
template<int NL, typename VL, bool IS_DIFFUSIVE, typename Averaged=ReducedDensityOperator<1> > 
...
template<int NL, typename VP, typename VL, bool IS_DIFFUSIVE, typename Averaged=ReducedDensityOperator<1> >
